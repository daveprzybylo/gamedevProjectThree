...
class Enemy(DirectObject):
    ...
    def _setup_collisions(self):
        ...
        self._ground_coll = CollisionNode('coll-ground')
        ...
        self._sight_coll = CollisionNode('coll-sight')
        ...
        self._sight_coll_hi = CollisionNode('coll-sight-hi')
        ...
        self._sight_coll_lo = CollisionNode('coll-sight-lo')
        ...
        self._player_coll = CollisionNode('coll-sphere')
